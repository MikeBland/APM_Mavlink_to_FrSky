...
//extern uint8_t ErrorId ;

//extern uint8_t DebugOutputOn ;

//extern void putmc( uint8_t c ) ;
//extern void twoHex( uint8_t c ) ;
//extern void crlf() ;
...
typedef char prog_uint8_t __attribute__((__progmem__));//,deprecated("prog_char type is deprecated.")));
...
#define APM __attribute__(( section(".progmem.data") ))
	...
	static const prog_uint8_t APM mavlink_message_crcs[256] = MAVLINK_MESSAGE_CRCS;
