...
const prog_char APM MSG01[] = "ARMING MOTORS"; 
const prog_char APM MSG02[] = "PreArm: RC not calibrated"; 
const prog_char APM MSG03[] = "PreArm: Baro not healthy";
const prog_char APM MSG04[] = "PreArm: Compass not healthy";
const prog_char APM MSG05[] = "PreArm: Bad GPS Pos";
const prog_char APM MSG06[] = "compass disabled";
const prog_char APM MSG07[] = "check compass";
const prog_char APM MSG08[] = "Motor Test: RC not calibrated";
const prog_char APM MSG09[] = "Motor Test: vehicle not landed";
const prog_char APM MSG10[] = "Crash: Disarming";
const prog_char APM MSG11[] = "Parachute: Released";
const prog_char APM MSG12[] = "error setting rally point";
const prog_char APM MSG13[] = "AutoTune: Started";
const prog_char APM MSG14[] = "AutoTune: Stopped";
const prog_char APM MSG15[] = "Trim saved";
const prog_char APM MSG16[] = "EKF variance";
const prog_char APM MSG17[] = "verify_nav: invalid or no current nav";
const prog_char APM MSG18[] = "verify_conditon: invalid or no current condition";
const prog_char APM MSG19[] = "Disable fence failed (autodisable)";
const prog_char APM MSG20[] = "ESC Cal: restart board";
const prog_char APM MSG21[] = "ESC Cal: passing pilot thr to ESCs";
const prog_char APM MSG22[] = "Low Battery";
const prog_char APM MSG23[] = "Lost GPS";
const prog_char APM MSG24[] = "Fence disabled (autodisable)";
const prog_char *const MsgPointers[24] PROGMEM = {MSG01, MSG02, MSG03, MSG04, MSG05, MSG06, MSG07, MSG08, MSG09, MSG10, MSG11, MSG12, MSG13, MSG14, MSG15, MSG16, MSG17, MSG18, MSG19, MSG20, MSG21, MSG22, MSG23, MSG24};
#define MAX_MSG 24
...
//extern uint8_t FOerrors ;
//extern uint8_t FOproblem ;
//extern uint8_t FIerrors ;

//void putmc( uint8_t c )
//{
...
bool Mavlink::getBit(byte Reg, byte whichBit) {
    bool State;
